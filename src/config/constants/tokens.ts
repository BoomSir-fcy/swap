...
export const DSG: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0xf8e8c2e77c47B9da858477341a649823f500c295',
    18,
    'DSG',
    'Dinosaur eggs',
  ),
...
export const BUSD: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0x0858241B08b1335d7711838D6cC9C60a72c92C4B',
    18,
    'BUSD',
    'Binance USD',
  ),
  [ChainId.MATIC_TESTNET]: new Token(
    ChainId.MATIC_TESTNET,
    '0x78fDF2e6c4929cE9AF0a5C93fe7F15A5aBbF0255',
    18,
    'BUSD',
    'Binance USD',
  ),
...
export const USDT: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(ChainId.TESTNET, '0xF1ED7fc67777eB6868f9c4B2b081aaC85c10b1b9', 18, 'USDT', 'Tether USD'),
}
export const VAI: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, '0x4BD17003473389A42DAF6a0a729f6Fdb328BbBd7', 18, 'VAI', 'Vai'),
  [ChainId.TESTNET]: new Token(ChainId.TESTNET, '0x5b0663ecb9cdfe770214aa6324de5253f15ff2e1', 18, 'VAI', 'Vai'),
  [ChainId.MATIC_TESTNET]: new Token(ChainId.MATIC_TESTNET, '0xB7AeaDD563299527b5d735EeffE4F5aB5c524D70', 18, 'VAI', 'Vai'),
}
export const XVS: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, '0xcF6BB5389c92Bdda8a3747Ddb454cB7a64626C63', 18, 'XVS', 'Venus'),
  [ChainId.TESTNET]: new Token(ChainId.TESTNET, '0x997003114c52945798c48757021938c257c76a57', 18, 'XVS', 'Venus'),
}
...
const tokens = {
  ...
  dsg: {
    ...
    address: {
      ...
      80001: '0xd53e9a38bd4c6BD06cBbc3ff94f98795D027e7FF',
    },
    decimals: 18,
  ...
  dsgff: {
    ...
    address: {
      ...
      80001: '0xA4C4740651b74920397899C9Af6C1F02753Aaf23',
    },
    decimals: 18,
    projectLink: 'https://dsgmetaverse.com/',
  },
  ...
  dsgycdbf: {
    symbol: 'METAYCDBF',
    name: 'METAYC Drawing Boards Fragment',
    address: {
      56: '0x129776B15DD8b102d2a131df32038782E0428741',
      97: '0x0Ea4183b3C674F02175fce682DeC1dF1995e7d44',
    },
    decimals: 18,
    projectLink: 'https://dsgmetaverse.com/',
  },
  ...
  vai: {
    ...
    address: {
      ...
      80001: '0xB7AeaDD563299527b5d735EeffE4F5aB5c524D70',
    },
    decimals: 18,
  ...
  wbnb: {
    ...
    address: {
      ...
      97: '0xD2754634e39cC8aaC7b8174af7e0552545cF63CB',
    },
    decimals: 18,
    projectLink: 'https://pancakeswap.finance/',
  },
  ...
  busd: {
    ...
    address: {
      ...
      80001: '0x78fDF2e6c4929cE9AF0a5C93fe7F15A5aBbF0255',
    },
    decimals: 18,
  ...
  usdc: {
    ...
    address: {
      ...
      97: '0x8c5F25a3b21c67f354Fde8C2dEC043510Ecbf73E',
      80001: '0x5ebc03c246C836cDfB5DB27eAF44Ea5678D6e26b',
    },
    decimals: 18,
  ...
  dai: {
    ...
    address: {
      ...
      97: '0x07a9d709C4B3CAee74B9eacC4774a8ACFB84acEF',
    },
    decimals: 18,
  ...
  usdt: {
    ...
    address: {
      ...
      97: '0xF1ED7fc67777eB6868f9c4B2b081aaC85c10b1b9',
      80001: '0x05bC09EF08BB801a249f456e158BdA400edb283A',
