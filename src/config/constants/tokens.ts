...
export const USDT: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    "0xF1ED7fc67777eB6868f9c4B2b081aaC85c10b1b9",
    18,
    "USDT",
    "Tether USD"
  ),
...
export const VAI: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    "0x5b0663ecb9cdfe770214aa6324de5253f15ff2e1",
    18,
    "VAI",
    "Vai"
  ),
  [ChainId.MATIC_TESTNET]: new Token(
    ChainId.MATIC_TESTNET,
    "0xB7AeaDD563299527b5d735EeffE4F5aB5c524D70",
    18,
    "VAI",
    "Vai"
  ),
...
export const XVS: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    "0x997003114c52945798c48757021938c257c76a57",
    18,
    "XVS",
    "Venus"
  ),
