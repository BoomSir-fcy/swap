...
export class Pair {
  ...
  public static getAddressForFactoryAddress(
    tokenA: Token,
    tokenB: Token,
  ...
  public constructor(
    ...
    this.liquidityToken = new Token(
      ...
      factoryAddress
        ? Pair.getAddressForFactoryAddress(tokenAmounts[0].token, tokenAmounts[1].token, factoryAddress, initCodeHash)
